...
desc 'Generate documentation for the zone_pricing extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ZonePricingExtension'
...
desc 'Test the zone_pricing extension.'
...
namespace :test do
  desc 'Functional test the zone_pricing extension.'
  ...
  desc 'Unit test the zone_pricing extension.'
